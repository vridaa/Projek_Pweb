...
<body background="bg.png" class="overflow-y-hidden">
    ...
    <div class="d-flex flex-column flex-shrink-0 p-3 cal-auto col-md-2 min-vh-100" style="background-color: rgba(139, 200, 230, 0.8);">
        ...
        <div class="d-flex flex-grow mx-5">
            <div class="container m-5 p-3 rounded bg-light bg-secondary" style="width: 60vw; min-height: 200px auto;">
                ...
                ?>
                            <div class="alert alert-danger alert-dismissible fade show" role="alert">
                                <strong>Uangmu Tidak Mencukupi!</strong> Silahkan Isi Saldo Terlebih Dahulu
                                <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button>
                            </div>
                <?php
                        }
                        else if($_GET['info'] == "suspend" || $_GET['info'] == 'tersuspend'){
                ?>
                        <div class="alert alert-danger alert-dismissible fade show" role="alert">
                                <strong>Maaf Akun Telah Tersuspend</strong>
                                <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button>
                        </div>
                <?php
                        }
                ...
                ?>
                <form action="func_kirimuang.php" method="post">
                <div class="input-group mb-3">
                    <input type="text" class="form-control" placeholder="Nomor Rekekning" aria-label="Recipient's username" name="norek" id="keyword" autocomplete="off">
                    <!-- <button class="btn btn-outline-secondary" type="button" id="button-cari">Cari</button> -->
                </div>
                    <!-- <input type="text" class="form-control w-100" name="norek"> -->
                </form>
                <div id="content" class="h-auto overflow-y-auto">
                    <table>
