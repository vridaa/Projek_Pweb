...
<html lang="en">
    ...
    <div class="d-flex flex-column flex-shrink-0 p-3 cal-auto col-md-2 min-vh-100" style="height: 100%; background-color: rgba(139, 200, 230, 0.8);">
        ...
        <div class="d-flex flex-grow my-5 text-center mx-5">
            <?php 
            ...
            <div class="container-fluid rounded mx-5" style="height: 500px; width: 1000px; background-color: none ">
                    <div class="d-flex mx-5 my-5">
                        ...
                        <form action="func_gantipass.php" method="post" onsubmit="return validate()">
                        <div class="card mx-5 mb-3 text-start" style="width: 750px;">
                        <div class="row g-0 ">
                            <div class="card-body">
                                <h5 class="card-title text-center">Profil Saya</h5>
                                <?php if (isset($_GET['info'])) { 
                                    if($_GET['info']=='tidakada'){?>
                                            <div class="alert alert-danger alert-dismissible fade show" role="alert">
                                                <strong>Password Lama Mu Salah!</strong>
                                ...
                                <p class="card-text ">
                                    ...
                                    <input type="hidden" name="id_pengguna" value="<?php echo $_SESSION['id'];?>">
                                <div class="row mb-3 ">
                                    <label for="pasword1" class="col-sm-3 col-form-label">Ganti Password&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;: </label>
                                ...
                                <div class="row mb-3 ">
                                    ...
                                    <div class="col-sm-9 text-start">
                                        <input required minlength="7" type="password" class="form-control w-75" name="np"  id="password" placeholder="masukkan password baru">
                                    </div>
                                </div>
                                <div class="row mb-3 ">
                                ...
                                <center>
                                <p class="card-text">
                                    <button type="submit" class="btn btn-primary" style="--bs-btn-padding-y: .5rem; --bs-btn-padding-x: 2rem; --bs-btn-font-size: .75rem;">Ganti</button>
                                    <button type="reset" class="btn btn-danger" style="--bs-btn-padding-y: .5rem; --bs-btn-padding-x: 2rem; --bs-btn-font-size: .75rem;">Batal</button>
                                </p>
                                </center>
                            </div>
                        </div>
