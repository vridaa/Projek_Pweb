...
<body background="bg.png" class="overflow-y-hidden">
    ...
    <div class="d-flex flex-column flex-shrink-0 p-3 cal-auto col-md-2 min-vh-100" style="background-color: rgba(139, 200, 230, 0.8);">
        ...
        <div class="d-flex flex-grow my-5 text-center mx-5" style="width: 75vw;">
            <div class="container m-5 rounded p-0" style="height: 400px; width: 60vw; background-color:rgba(0, 0, 0, 0.04)">
            <div class="contaniner rounded-top pt-2 pb-2" style=" height:100px; width : 60vw;  margin: left 5px;; background-color: #10467d">
                    <div class="text-white text-center my-4">
                    <h3>Masukkan Nominal Yang Anda Inginkan</h3>
                    <?php
                        if(isset($_GET['info'])){
                            if($_GET['info'] == 'suspend'){
                    ?>
                            <div class="alert alert-danger alert-dismissible fade show" role="alert">
                                <strong>Maaf Akun Anda Telah Tersuspend!!</strong>
            ...
            <br>
            <br>
                <form action="func_isi_saldo.php?id_pengguna=<?php echo $id_pengguna; ?>" method="post">
                    <div class="px-5 my-3">
                    <div class="d-flex px-5 text-center my-2">
                        <h4>Rp.&emsp;&emsp;</h4>
                        <input type="text" name="nominal" class="form-control w-75">
                    </div>
                    <br><br><br><br>
                        <center>
                            <button class="btn btn-primary w-25">Tambah</button>
                        </center>
                    </div>
                </form>
            </div>
