...
<head>
    ...
    <title>Daftar Transaksi | TabunganQu</title>
</head>
<body background="bg.png" style="height:100vh;">
    <div class="d-flex overflow-y-hidden">
    <div class="d-flex flex-column flex-shrink-0 p-3 cal-auto col-md-2" style="height:100vh;background-color: rgba(139, 200, 230, 0.8);">
            ...
            <ul class="nav nav-pills flex-column mb-auto mx-1 w-25">
                ...
                <br>
                <li class="nav-item">
                    <a class="nav-link active" style="width: 14vw; background-color:#2a4080;" aria-current="page" href="daftar_transaksi.php"><svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor" class="bi bi-clock-history" viewBox="0 0 16 16">
        ...
        <?php
            ...
            $query = mysqli_query($conn, "SELECT * FROM transaksi WHERE id_pengguna = '$id_pengguna'");
        ...
        <div class="d-flex flex-grow mx-5 overflow-y-auto overflow-x-hidden" style="height:100vh;">
            <div class="container m-5 p-3 w-auto rounded ">
                <div class="table table-dark table-hover">
                    <table border="1px" class="table table-hover" style="width: 800px;">
                        <?php
                            if ($cek_data == 0){
                                echo "<td> Belum Ada Riwayat Untuk Anda Saat Ini <td>";
                            }
                            else{?>
                                <tr class="sticky-top">
                        ...
                        ?>
                                    ...
                                    <tr  class="table-primary">
                                        ...
                                        <td><?php echo $data['judul_transaksi']; ?></td>
